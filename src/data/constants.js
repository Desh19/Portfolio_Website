...
export const Bio = {
  ...
  resume:
    "https://drive.google.com/file/d/1s2GlvNgRFy2zC3ySKozPjY7U_BrM6S3M/view?usp=sharing",
...
export const skills = [
  {
    ...
    skills: [
      ...
      },
      {
        name: "CSS",
        image:
          "https://img.icons8.com/?size=100&id=11935&format=png&color=000000",
      },
      {
        name: "JavaScript",
        image:
...
export const experiences = [
  {
    ...
    desc: [
      ...
      "Collaborate with stakeholders, designers, QA, and backend teams to deliver business requirements.",
      "Drive engineering efficiency through Agile processes and continuous improvement.",
    ],
  },
  {
    id: 0,
    ...
    desc: [
      "Developed and maintained production-grade Angular and React applications.",
      "Built reusable UI components and integrated REST APIs.",
      "Implemented responsive and user-friendly interfaces for business-critical systems.",
      "Participated in code reviews, sprint planning, testing, and deployment activities.",
    ],
  },
  {
    id: 0,
    ...
    desc: [
      ...
      "Implemented UI enhancements, bug fixes, and API integrations.",
...
export const education = [
  ...
  },
  {
    ...
    desc: "I completed school education at Ananda Sastralaya - Kotte, I complete GCE Ordinary level - 2015 and GCE Advance level - 2018 at the school.",
...
export const TimeLineData = [
  { year: 2015, text: "complete O/L s" },
  { year: 2018, text: "complete A/L s" },
